...
The `number of followers` of users in Chile on `2026/9/2 2:21 AM UTC`. This list contains users from `Chile` and cities `Santiago` `Valparaíso` `Viña-del-mar` `Arica` `Temuco` `Concepcion` `Puerto-montt`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/dcortesnet">
				<img src="https://avatars.githubusercontent.com/u/20870950?s=72&v=4" width="24" alt="Avatar of dcortesnet"> dcortesnet
			</a><br/>
			Diego C
		</td>
		<td>Software </td>
	...
	<tr>
		...
		<td>Comunidad Virtual Limitada </td>
		<td>No Twitter Username</td>
		<td>Santiago, Chile</td>
		<td>33</td>
	</tr>
